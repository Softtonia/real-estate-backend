...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('custom_field_repeater_options', function (Blueprint $table) {
            ...
            $table->string('type', 100)->collation('utf8mb4_general_ci')->nullable();
            $table->text('name')->collation('utf8mb4_general_ci')->nullable();
            $table->text('value')->collation('utf8mb4_general_ci')->nullable();
