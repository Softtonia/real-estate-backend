    ...
    public function run(): void
    {
        DB::table('client_reviews')->insert([
            ...
            [
                ...
                'review' => 'I have been using holiplaces.com as an individual since its launch, and as a real estate professional since a few years.',
                'status' => '1',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'review' => 'holiplaces.com and I started in the Real Estate business at almost the same time. This web portal just provided the best platform I needed to make a launch. After 5 year, I have a l...',
                'status' => '1',
                'created_at' => now(),
                'updated_at' => now(),
            ],
