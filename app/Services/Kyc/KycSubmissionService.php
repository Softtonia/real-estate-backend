...
class KycSubmissionService
{
    ...
    private function copyApprovedDocumentsFromPreviousRequest(
         ...
         *   - STATUS_PENDING   – documents that were never individually reviewed
         *                        (common when the admin rejects the whole KYC
         *                         request without reviewing each document)
         *
         * Only STATUS_REJECTED documents are excluded, as the user must
         * re-upload those.
         */
        ...
        foreach ($carryOverDocs as $doc) {
            ...
            if (!$alreadyExists) {
                ...
                /*
                 * Preserve the original status so the admin panel can see
                 * which documents are already approved vs. which are pending
                 * re-review.
                 */
