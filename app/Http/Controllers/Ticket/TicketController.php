    ...
    public function index()
{
    ...
    $tickets = DB::table('tickets')
            ...
            ->select('raised_users.id as raised_by_id', 'raised_users.fullname as raised_user_name', 
                      'assigned_users.id as assigned_to_id', 'assigned_users.fullname as assigned_user_fullname', 
                      'tickets.*', 'ticket_priorities.ticket_priority','ticket_status.ticket_status_name','ticket_types.ticket_type_name')
            ->get();
