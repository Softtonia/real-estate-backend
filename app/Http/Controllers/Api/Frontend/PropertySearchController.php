...
{
    public function options(PropertySearchService $service): JsonResponse
    {
        try {
            ...
            return $this->serverError('Unable to fetch property search options.', $e);
        }
    }
    ...
    public function locationSuggestions(
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => $service->locationSuggestions($request->only('search')),
            ]);
        } catch (Throwable $e) {
            return $this->serverError('Unable to fetch location suggestions.', $e);
        }
    }
    ...
    public function search(
        ...
        try {
            $properties = $service->search($request->validated());
            ...
            return $this->serverError('Unable to search properties.', $e);
        }
    }
