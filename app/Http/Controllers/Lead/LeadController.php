    ...
    public function index()
{
    ...
    // Collect all user_ids from all leads to fetch in one query
    ...
    $leads->map(function ($lead) use ($users) {
        ...
        $lead->users = collect($userIds)
            ...
            ->filter(); // remove nulls if user not found
        return $lead;
    });
    ...
    public function store(Request $request)
    {
        ...
        $lead = Lead::create([
            ...
            'user_ids' => json_encode(array_unique($userIds)),
        ]);
    ...
    public function update(Request $request, $id)
{
    ...
    $userIds = $request->user_ids ?? [];
    $existingUserIds = json_decode($lead->user_ids, true) ?: [];
    $allUserIds = array_unique(array_merge($existingUserIds, $userIds));
    ...
    $lead->update([
        ...
        'project_id' => $request->project_id,
        'developer_id' => $request->developer_id,
        'user_ids' => json_encode($allUserIds),
    ]);
