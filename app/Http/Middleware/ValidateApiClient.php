...
class ValidateApiClient
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error('ValidateApiClient exception: ' . $e->getMessage());
    ...
    private function updateLastUsed(Request $request, $client, ApplicationPassword $applicationPassword): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error('ValidateApiClient updateLastUsed error: ' . $e->getMessage());
        }
    }
